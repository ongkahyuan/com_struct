...
module auto_alu_tester_7 (
  ...
  localparam INPUT_A = 16'habcd;
  localparam INPUT_B = 16'hef42;
  localparam OPCODE = 6'h00;
  localparam EXPECTED = 16'h9b0f;
...
<<<<<<< HEAD:16 Bit ALU/work/verilog/auto_alu_tester_7.v
    io_seg = 8'h00;
    io_sel = 4'h0;
...
=======
    ...
    b = 16'h0000;
    expected = 16'h002a;
>>>>>>> b02f176be14280e4bccc160ef1acaa0586c174ee:16 Bit ALU/work/vivado/16 Bit ALU/16 Bit ALU.srcs/sources_1/imports/verilog/auto_alu_tester_41.v
    M_out_d = M_alu_out;
    opcode_led = 6'h00;
    ...
    case (M_state_q)
      ...
      OUT_state: begin
        ...
        io_seg = ~M_seg_display_seg;
        io_sel = ~M_seg_display_sel;
        if (M_timerClock_out && M_out_q == 16'h9b0f) begin
