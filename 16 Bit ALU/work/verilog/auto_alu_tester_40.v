...
module auto_alu_tester_40 (
  ...
  localparam INPUT_A = 16'h001f;
  localparam INPUT_B = 16'h0015;
  localparam OPCODE = 6'h07;
  localparam EXPECTED = 16'h000a;
  ...
  always @* begin
    ...
    case (M_state_q)
      ...
      OUT_state: begin
        ...
        io_seg = ~M_seg_display_seg;
        io_sel = ~M_seg_display_sel;
        if (M_timerClock_out && M_out_q == 16'h000a) begin
