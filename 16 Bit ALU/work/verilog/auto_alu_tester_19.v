...
module auto_alu_tester_19 (
  ...
  localparam INPUT_A = 16'h4242;
  localparam INPUT_B = 16'h4242;
  localparam OPCODE = 6'h1a;
  localparam EXPECTED = 16'h4242;
  ...
  always @* begin
    ...
    case (M_state_q)
      ...
      OUT_state: begin
        ...
        io_seg = ~M_seg_display_seg;
        io_sel = ~M_seg_display_sel;
        if (M_timerClock_out && M_out_q == 16'h4242) begin
