...
/*
   Parameters:
     ...
     EXPECTED = 16h0000
*/
module auto_alu_tester_37 (
    input clk,
    input rst,
    input start,
    output reg [7:0] io_seg,
    output reg [3:0] io_sel,
    output reg opcode_led,
    output reg done
  );
  
  localparam INPUT_A = 16'hff00;
  localparam INPUT_B = 16'h00ff;
  localparam OPCODE = 6'h1f;
  localparam EXPECTED = 16'h0000;
  ...
  always @* begin
    ...
    case (M_state_q)
      ...
      OUT_state: begin
        ...
        io_seg = ~M_seg_display_seg;
        io_sel = ~M_seg_display_sel;
        if (M_timerClock_out && M_out_q == 16'h0000) begin
