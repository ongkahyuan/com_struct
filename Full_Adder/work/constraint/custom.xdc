...
set_property PACKAGE_PIN N13 [get_ports {customout[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {customout[0]}]
set_property PACKAGE_PIN N11 [get_ports {customout[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {customout[1]}]
set_property PACKAGE_PIN P10 [get_ports {customout[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {customout[2]}]
set_property PACKAGE_PIN T13 [get_ports {customin[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {customin[0]}]
set_property PULLDOWN true [get_ports {customin[0]}]
set_property PACKAGE_PIN T12 [get_ports {customin[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {customin[1]}]
set_property PULLDOWN true [get_ports {customin[1]}]
