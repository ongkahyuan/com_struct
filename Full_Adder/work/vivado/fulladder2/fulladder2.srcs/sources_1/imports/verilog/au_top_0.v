...
module au_top_0 (
  ...
  wire [4-1:0] M_output_states_value;
  wire [1-1:0] M_output_states_a;
  wire [1-1:0] M_output_states_b;
  wire [1-1:0] M_output_states_cin;
  reg [1-1:0] M_output_states_inc;
  testcounter_7 output_states (
    .clk(clk),
    .rst(rst),
    .inc(M_output_states_inc),
    .value(M_output_states_value),
    .a(M_output_states_a),
    .b(M_output_states_b),
    .cin(M_output_states_cin)
  );
  ...
  always @* begin
    ...
    io_led = 24'h000000;
    usb_tx = usb_rx;
    customout[0+0-:1] = M_output_states_a;
    M_fa_x = M_output_states_a;
    customout[1+0-:1] = M_output_states_b;
    M_fa_y = M_output_states_b;
    customout[2+0-:1] = M_output_states_cin;
    M_fa_cin = M_output_states_cin;
    M_chk_sum1 = customin[0+0-:1];
    M_chk_sum2 = M_fa_s;
    M_chk_cout1 = customin[1+0-:1];
    M_chk_cout2 = M_fa_cout;
    io_led[16+0+0-:1] = M_chk_out;
    if (M_chk_out == 1'h0) begin
      io_led[8+7+0-:1] = 1'h1;
    end
    M_buttoncond_in = io_button[0+0-:1];
    M_buttondetector_in = M_buttoncond_out;
    M_output_states_inc = M_buttondetector_out;
    M_seg_values = M_output_states_value;
    io_led[16+5+0-:1] = M_output_states_a;
    io_led[16+6+0-:1] = M_output_states_b;
    io_led[16+7+0-:1] = M_output_states_cin;
